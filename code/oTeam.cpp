...
void oTeam::setBib(const string &bib, int bibnumerical, bool updateStartNo, bool setTmpOnly) {
  if (setTmpOnly) {
    tmpStore.bib = bib;
    if (updateStartNo)
